                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p class="animated fadeInUp"><a href="#"
                                    class="btn btn-transparent btn-rounded btn-large">Learn
                                    More</a></p>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p class="animated fadeInRight"><a href="#"
                                    class="btn btn-transparent btn-rounded btn-large">Learn
                                    More</a></p>
                        </div>
                    </div>
        ...
        <div id="roomCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            <div class="carousel-inner">
                ...
                @forelse ($rooms as $room)
                    ...
                    @if ($loop->index == 0)
                        <div class="carousel-item active">
                            <img src="{{ $roomImage }}" class="d-block w-100" alt="Room 1" />
                            <div class="carousel-caption text-start animate__animated animate__fadeInLeft">
                                ...
                                <a href="{{ route('room.show', ['id' => $room->room_id]) }}"
                                    class="btn btn-success btn-lg animate__animated animate__zoomIn mt-3">Explore
                                    Now</a>
                            </div>
                        </div>
                    @elseif ($loop->index == 1)
                        <!-- Slide 2 -->
                        <div class="carousel-item">
                            <img src="{{ $roomImage }}" class="d-block w-100" alt="Room 2" />
                            <div class="carousel-caption text-center animate__animated animate__fadeInDown">
                                ...
                                <a href="{{ route('room.show', ['id' => $room->room_id]) }}"
                                    class="btn btn-outline-light btn-lg animate__animated animate__fadeInUp mt-3">See
                                    Features</a>
                            </div>
                        </div>
                    @else
                        <!-- Slide 3 -->
                        <div class="carousel-item">
                            <img src="{{ $roomImage }}" class="d-block w-100" alt="Room 3" />
                            <div class="carousel-caption text-end animate__animated animate__fadeInRight">
                                ...
                                <a href="{{ route('room.show', ['id' => $room->room_id]) }}"
                                    class="btn btn-warning btn-lg animate__animated animate__fadeInUp mt-3">Book
                                    Now</a>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active testimonial-item">
                        <div class="testimonial-img-box mx-auto">
                          <img src="https://placehold.co/135x135" class="d-block img-fluid rounded-circle" alt="Paula Wilson">
                        </div>
                      ...
                      <div class="carousel-item testimonial-item">
                        <div class="testimonial-img-box mx-auto">
                          <img src="https://placehold.co/135x135" class="d-block img-fluid rounded-circle" alt="Antonio Moreno">
                        </div>
                      ...
                      <div class="carousel-item testimonial-item">
                        <div class="testimonial-img-box mx-auto">
                          <img src="https://placehold.co/135x135" class="d-block img-fluid rounded-circle" alt="Michael Holz">
                        </div>

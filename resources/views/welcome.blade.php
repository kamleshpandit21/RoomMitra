                    ...
                    <div class="card room-card shadow-lg rounded" data-aos="fade-up" data-aos-delay="{{ $delay }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button
                                    class="btn btn-sm like-btn {{ $wishlisted ? 'btn-danger' : 'btn-outline-danger' }}"
        ...
        <div class="container">
            <div class="row justify-content-center" data-aos="fade-up">
                <div class="col-12 text-center mb-5">
                    <span class="custom-badge text-white mb-3 d-inline-block" data-aos="fade-down"
                        data-aos-delay="100">Our Services</span>
                    <h2 class="display-5 fw-bold mb-3 heading" data-aos="zoom-in" data-aos-delay="300">Why Choose
                        RoomMitra</h2>
                        ...
                        <div class="icon-wrapper mb-4">
                            <svg height="44px" width="44px" version="1.1" id="Layer_1"
                                ...
                                <path style="fill:#64798A;"
                                    d="M434.564,270.813v114.79c31.456,0,56.956-25.697,56.956-57.395
                                ...
                                <path style="fill:#E1E6E9;"
                                    d="M99.141,231.325L99.141,231.325v193.768l0,0c-23.298,0-42.185-19.033-42.185-42.51V273.835

...
@section('content')
    ...
    <section class="text-center py-5 bg-light">
        <div class="container">
            ...
            <p class="text-muted">We usually respond within 24 hours. Feel free to reach out for any questions or support
                needs.</p>
        </div>
    </section>
    <section class="contact-us bg-light py-5" id="contact">
        <div class="container px-4 px-md-5">
            ...
            <div class="row mt-5 text-center animate__animated animate__fadeInUp">
                <div class="col">
                    <p class="lead mb-0">
                        🤖 Need quick help? <a href="{{ route('faqs') }}" class="text-success fw-bold">Check our FAQs</a> or
                        chat with our
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (response.ok) {
                        alert(data.message || "Message submitted successfully!");
                        form.reset();
                    } else {

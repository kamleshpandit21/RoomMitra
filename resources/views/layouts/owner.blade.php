...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.html" class="brand-link">
        <img src="https://placehold.co/600x400" alt="Property Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                ...
                <img src="{{ asset('img/avatar/avatar.png')}}" class="img-circle elevation-2" alt="Owner Image">
            </div>
            <div class="info">

        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <img src="{{ asset($room->images->first()->image_url) }}" alt="Room Image"
          ...
          @endif
            ...
            <td class="d-flex justify-content-center gap-2 flex-wrap">
              <a href="{{ route('owner.rooms.edit', $room->room_id) }}" class="btn btn-sm btn-outline-primary">✏️</a>
              <form action="{{ route('owner.rooms.destroy', $room->room_id) }}" method="POST" onsubmit="return confirm('Delete this room?')">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-sm btn-outline-danger">🗑️</button>
              </form>
              <a href="{{ route('owner.rooms.show', $room->room_id) }}" class="btn btn-sm btn-outline-info">👁️</a>
            </td>
          </tr>
          @endforeach
          <!-- Loop End -->
